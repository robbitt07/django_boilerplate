...
options.DEFAULT_NAMES = options.DEFAULT_NAMES + (
    "cache_keys", "save_cache_keys", "delete_cache_keys"
)


ROOT_URLCONF = "yabpt.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {
                "base_utils": "utils.templatetags.base_utils",
            }
        },
    },
]

WSGI_APPLICATION = "yabpt.wsgi.application"
...
CACHES = {
    "default": {
        "BACKEND": "utils.yahp.cache.DatabaseCacheExtended",
